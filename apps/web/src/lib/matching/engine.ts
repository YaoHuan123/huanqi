      ...
      data: [
        {
          ...
          body: `Someone else's sensation resonated at ${scorePct}%. Open Matches to read the preview.`,
          matchId: match.id,
        },
        {
          ...
          type: "match",
          title: "New resonance match",
          body: `A new sensation resonated with yours at ${scorePct}%. Open Matches to read the preview.`,
          matchId: match.id,
        },
      ],
    });
